...
import com.linkhand.kits.MyImageLoader;
...
public class HotGoodsDetailAdapter extends CommonAdapter {
    private Context mContext;
    private List<Picture> mList;
    int width;

    public HotGoodsDetailAdapter(Context context, int layoutId, List datas) {
