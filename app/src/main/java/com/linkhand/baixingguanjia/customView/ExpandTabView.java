...
import com.linkhand.baixingguanjia.utils.PopUIHelper;
...
//			r.setAlpha(0.0f);
	...
	private void startAnimation(){
		...
		PopUIHelper.setPopupWindowTouchModal(popupWindow, false);
	...
	private void showPopup(int position) {
		...
		if (tView instanceof PopViewBaseActionListener) {
			PopViewBaseActionListener f = (PopViewBaseActionListener) tView;
			f.show();
		}
