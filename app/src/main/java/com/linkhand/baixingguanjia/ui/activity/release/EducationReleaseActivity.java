        ...
        mGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
                ...
                if (imgPaths.get(position).equals("")) {
                    ...
                    //开始预览
                    Intent intent = new Intent(EducationReleaseActivity.this, MultiPhotoViewActivity.class);
...
//                    initListener();
    ...
    private void setViewData() {
        ...
        categoryStr = mEducation.getCategory();
        mCommonObjectType = new CommonType(mEducation.getType() + "", mEducation.getDuixiang());
        mCommonType = new CommonType(mEducation.getObject(), mEducation.getLeibie());
        mGoodsType.setText(mEducation.getLeibie());//
        mObjectType.setText(mEducation.getDuixiang());
        mTitleET.setText(mEducation.getTitle()); //标题
        mDescribeTV.setText(mEducation.getContent());
        mContactET.setText(mEducation.getCreator()); //
        mPhoneET.setText(mEducation.getPhone());
        shengId = mEducation.getSheng();
        shiId = mEducation.getShi();
        quId = mEducation.getQu();
        xiaoquId = mEducation.getXiaoqu();
        mAddressTV.setText(mEducation.getCounty() + mEducation.getVillage()); //
        mCompanyNameTV.setText(mEducation.getCompany());
        imgPaths.clear();
...
//        horizontal_layout(imgPaths, mGridView);
    ...
    @OnClick({R.id.back, R.id.abstract_layout, R.id.submit, R.id.image_df, R.id.sort_layout, R.id.location_layout, R.id.object_layout})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.sort_layout:
                ...
                bundle.putString("flag", "educationtype");
                go(CommonSelectedTypeActivity.class, bundle);
                break;
            case R.id.object_layout:
                Bundle bundle2 = new Bundle();
                bundle2.putSerializable("type", mCommonObjectType);
                bundle2.putString("flag", "educationObjecttype");
                go(CommonSelectedTypeActivity.class, bundle2);
                break;
            case R.id.location_layout:
                Bundle bundleP = new Bundle();
                bundleP.putString("acFlag", "EducationRelease");
...
//                onAddress2Picker();
            ...
            case R.id.abstract_layout:
                ...
                bundle1.putString("flag", "educationDescribe");
    ...
    private void showPaySuccessDialog() {
        final Dialog mDialog = new Dialog(EducationReleaseActivity.this, R.style.Dialog);
...
//        request.add("image",fileList);
    ...
    private void httpUploadInfo() {
        ...
        if (!flag.contains("update")) {
            request = NoHttp.createJsonObjectRequest(ConnectUrl.PUBLIC_EDUCATION_RELEASE, RequestMethod.POST);
...
//        Request<JSONObject> request = NoHttp.createJsonObjectRequest(ConnectUrl.PUBLIC_EDUCATION_RELEASE, RequestMethod.POST);
        ...
        request.add("data[object]", mCommonObjectType.getId());//类型4商家5个人
...
//                showToast(R.string.uploadFail);
    ...
    private void emptyView() {
        mGoodsType.setText("");//
        mTitleET.setText(""); //标题
        mDescribeTV.setText(""); //标题
        mContactET.setText(""); //标题
        mPhoneET.setText(""); //标题
        mAddressTV.setText(""); //标题
        mCompanyNameTV.setText(""); //标题
        imgPaths.clear();
        mAdapter.notifyDataSetChanged();
        initSelectPicView();
    }
    ...
    private void selectorImage() {
        ...
        Intent intent = new Intent(EducationReleaseActivity.this, ImageSelectorActivity.class);
    ...
    private void initSelectPicView() {
        if (imgPaths.size() == 1 && imgPaths.get(0).equals("")) {
            mPicBg.setBackground(getResources().getDrawable(R.drawable.icon_education_default));
...
//                    showToast("province : " + province + ", city: " + city + ", county: " + county);
    ...
    public void onEvent(EventFlag eventFlag) {
        ...
        if (eventFlag.getFlag().equals("educationObjecttype")) {
            mCommonObjectType = (CommonType) eventFlag.getObject();
            mObjectType.setText(mCommonObjectType.getName());
