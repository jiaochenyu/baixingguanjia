 ...
 * 发布善行
 */
public class PublicWelfareReleaseActivity extends BaseActivity {
    ...
    ImageView mImageAddressGo;

    private EditText mContactET;
    private EditText mPhoneET;


    String titleStr, desStr, contStr, phoneStr, addStr, locationStr; //locationStr 自动定位
    String categoryStr = "1";//【1寻人2寻物3善行】
    String quId;
    String xiaoquId;
    ...
    int sort = 1;// 【1寻人2寻物3善行】 入口


    PublicWelfare mWelfare;
    String shengId;
    String shiId;
    String goods_type = "";
    String goodsid = "";
    ...
    private void initView() {
        ...
        ((RadioButton) mRadiogroup.getChildAt(sort - 1)).setChecked(true);
    }
    ...
    private void initListener() {
        mGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
                ...
                if (imgPaths.get(position).equals("")) {
                    ...
                    //开始预览
                    Intent intent = new Intent(PublicWelfareReleaseActivity.this, MultiPhotoViewActivity.class);
        ...
        mRadiogroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, @IdRes int checkedId) {
                switch (checkedId) {
                    case R.id.find_people:// 寻人
                        categoryStr = "1";

                        break;
                    case R.id.find_goods: // 寻物
                        categoryStr = "2";

                        break;
                    case R.id.behavior: // 善行
                        categoryStr = "3";
...
//                    initListener();
    ...
    private void setViewData() {
        ...
        categoryStr = mWelfare.getCategory();

        mTitleET.setText(mWelfare.getTitle());
        mDescribeTV.setText(mWelfare.getContent());
        mContactET.setText(mWelfare.getCreator());
        mPhoneET.setText(mWelfare.getPhone());
        mAddressEdit.setText(mWelfare.getQuname()+mWelfare.getXiaoquname());
        shengId = mWelfare.getSheng();
        shiId = mWelfare.getShi();
        quId = mWelfare.getQu();
        xiaoquId = mWelfare.getXiaoqu();
        imgPaths.clear();
...
//        horizontal_layout(imgPaths, mGridView);
    ...
    @OnClick({R.id.back, R.id.abstract_layout, R.id.submit, R.id.image_df,R.id.address_layout})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.address_layout:
                ...
                bundleP.putString("acFlag", "WelfareRelease");
                go(ReleaseAreaSearchActivity.class, bundleP);
//                onAddress2Picker();
                break;
            case R.id.abstract_layout:
                Bundle bundle1 = new Bundle();
                bundle1.putString("flag", "welfareDescribe");
    ...
    private void judgeData() {
        ...
        addStr = mAddressEdit.getText().toString(); //地址
        ...
        if (TextUtils.isEmpty(addStr)) {
            showToast(R.string.toastSelectAddress);
            return;
        }
...
//                httpUploadInfo();
    ...
    private void httpUploadInfo() {
        ...
        if (!flag.contains("update")) {
            request = NoHttp.createJsonObjectRequest(ConnectUrl.PUBLIC_WELFARE_RELEASE, RequestMethod.POST);
        ...
        request.add("data[users_id]", MyApplication.getUser().getUserid());
...
//                showToast(R.string.uploadFail);
    ...
    private void selectorImage() {
        ...
        Intent intent = new Intent(PublicWelfareReleaseActivity.this, ImageSelectorActivity.class);
    ...
    private void initSelectPicView() {
        if (imgPaths.size() == 1 && imgPaths.get(0).equals("")) {
            mPicBg.setBackground(getResources().getDrawable(R.drawable.icon_gongyi_bg));
...
//                    showToast("province : " + province + ", city: " + city + ", county: " + county);
                    ...
                    mAddressEdit.setText(province.getName() + city.getName() + county.getName());
                }
            });
            picker.show();
        } catch (Exception e) {
    ...
    public void onEvent(EventFlag eventFlag) {
        if (eventFlag.getFlag().equals("welfareDescribe")) {
            mDescribeTV.setText((String) eventFlag.getObject());
        }
        if (eventFlag.getFlag().equals("WelfareRelease")) {
            Sheng s = (Sheng) eventFlag.getObject();
            quId = s.getQu().getId();
            xiaoquId = s.getXiaoqu().getId();
            mAddressEdit.setText(s.getQu().getName() + s.getXiaoqu().getName());
        }
...
//                horizontal_layout(imgPaths, mGridView);
    ...
    private void showPaySuccessDialog() {
        final Dialog mDialog = new Dialog(PublicWelfareReleaseActivity.this, R.style.Dialog);
