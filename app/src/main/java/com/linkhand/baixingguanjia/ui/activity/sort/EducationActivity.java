...
import com.linkhand.baixingguanjia.ui.adapter.EducationListViewAdapter;
...
public class EducationActivity extends BaseActivity {
    ...
    private PopViewList viewObject;
    private ArrayList<View> mViewArray = new ArrayList<View>();

    private List<String> objectItems = new ArrayList<>();
    private List<String> objectItemsVaule = new ArrayList<>();
    ...
    private EducationListViewAdapter mAdapter;
    ...
    private void initView() {
        List<CommonType> mTList = (List<CommonType>) SPUtils.get(this, "EducationType", new TypeToken<List<CommonType>>() {
        }.getType());
        Map<String, List<String>> map = JSONUtils.getStrArray(mTList);
        typeItems = map.get("items");
        typeItemsVaule = map.get("itemsValue");
        List<CommonType> mOList = (List<CommonType>) SPUtils.get(this, "EducationObjectType", new TypeToken<List<CommonType>>() {
        }.getType());
        Map<String, List<String>> map1 = JSONUtils.getStrArray(mOList);
        objectItems = map1.get("items");
        objectItemsVaule = map1.get("itemsValue");

        viewArea = new PopViewArea(this);
        viewType = new PopViewList(this, typeItems, typeItemsVaule, 2);
        viewObject = new PopViewList(this, objectItems, objectItemsVaule, 3);
    ...
    private void initData() {
        ...
        mSheng = (Sheng) SPUtils.get(EducationActivity.this, "UserLocation", Sheng.class);
        if (mSheng != null) {
...
//            mTextArray.set(0,mSheng.getShi().getName());
            ...
            Sheng sheng = (Sheng) SPUtils.get(EducationActivity.this, "DiQu", Sheng.class);
            shengId = sheng.getId();
        ...
        mList = new ArrayList<>();
        mAdapter = new EducationListViewAdapter(this, R.layout.item_education_info, mList);
    ...
    private void initListener() {
        ...
        //* 选择价钱
        viewObject.setOnSelectListener(new PopViewList.OnSelectListener() {

            @Override
            public void getValue(String value, String showText) {
                educationObjectId = value;
                v_bg.setVisibility(View.GONE);
                onRefresh(viewObject, showText);
                pageFlag = 1;
                showLoading();
                httpGetList();
            }
        ...
        mListview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                bundle.putSerializable("education", (Serializable) mList.get(position - 1));
    ...
    public void onEvent(EventFlag eventFlag) {
        if (eventFlag.getFlag().equals("offlineEducation")) {
    ...
    public void httpGetList() {
        Request<JSONObject> mRequest = NoHttp.createJsonObjectRequest(ConnectUrl.PUBLIC_EDUCATION_LIST, RequestMethod.POST);
        ...
        mRequest.add("object", educationObjectId);
                    ...
                    try {
                        ...
                        if (jsonObject.getInt("code") == 200) {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                Gson gson = new Gson();
                                Education education = gson.fromJson(jsonObject1.toString(), Education.class);
                                mList.add(education);
                            }
                        }
