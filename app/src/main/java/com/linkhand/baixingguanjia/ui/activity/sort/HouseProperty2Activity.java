...
import static com.linkhand.baixingguanjia.R.id.v_bg;
...
public class HousePropertyActivity extends BaseActivity {
    ...
    private List<String> salesItems = Arrays.asList(new String[]{"价格不限", "1万 元/平以下", "1万-1.5万 元/平", "1.5万-2万 元/平", "2万-3万 元/平", "3万 元/平以上"});
    private List<String> salesItemsVaule = Arrays.asList(new String[]{"0", "100", "115", "115", "152", "203","1000000"});
    ...
    private List<String> salesItemsRentVaule = Arrays.asList(new String[]{"0", "100", "115", "152", "203", "1000000"});
    private List<String> typeItems = Arrays.asList(new String[]{"户型", "1室", "2室", "3室", "4室"});
        ...
        mRadioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, @IdRes int checkedId) {
                switch (checkedId) {
                    case R.id.sell:
                        houseType = "2";
                        viewSales = new PopViewList(HousePropertyActivity.this, salesItems, salesItemsVaule, 3);
                        mViewArray.set(2,viewSales);
                        mExpandtabTab.notify();
                        break;
                    case R.id.rent:
                        houseType = "1";
                        viewSales = new PopViewList(HousePropertyActivity.this, salesItemsRent, salesItemsVaule, 3);
                        mViewArray.set(2,viewSales);
//                        mExpandtabTab.notify();
                        mExpandtabTab.setValue(mTextArray, mViewArray, mVBg);
                        break;
