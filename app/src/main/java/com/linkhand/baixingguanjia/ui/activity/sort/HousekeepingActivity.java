...
import com.linkhand.baixingguanjia.ui.adapter.HousekeepingListViewAdapter;
...
public class HousekeepingActivity extends BaseActivity {
    ...
    private HousekeepingListViewAdapter mAdapter;
    ...
    private void initView() {
        List<CommonType> mTList = (List<CommonType>) SPUtils.get(this, "HouseKeepingType", new TypeToken<List<CommonType>>() {
        }.getType());
...
//        mViewArray.add(viewSales);
        ...
        mSheng = (Sheng) SPUtils.get(HousekeepingActivity.this, "UserLocation", Sheng.class);
        if (mSheng != null) {
...
//            mTextArray.set(0,mSheng.getShi().getName());
            ...
            Sheng sheng = (Sheng) SPUtils.get(HousekeepingActivity.this, "DiQu", Sheng.class);
            shengId = sheng.getId();
        ...
        mList = new ArrayList<>();
        mAdapter = new HousekeepingListViewAdapter(this, R.layout.item_house_keeping_info, mList);
    ...
    private void initListener() {
        ...
        mListview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                bundle.putSerializable("keeping", (Serializable) mList.get(position - 1));
    ...
    public void onEvent(EventFlag eventFlag) {
        if (eventFlag.getFlag().equals("offlineKeeping")) {
    ...
    public void httpGetList() {
        Request<JSONObject> mRequest = NoHttp.createJsonObjectRequest(ConnectUrl.PUBLIC_HOUSEKEEEPING_LIST, RequestMethod.POST);
                    ...
                    try {
                        ...
                        if (jsonObject.getInt("code") == 200) {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                Gson gson = new Gson();
                                Housekeeping keeping = gson.fromJson(jsonObject1.toString(), Housekeeping.class);
                                mList.add(keeping);
                            }
                        }
