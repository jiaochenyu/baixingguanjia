...
public class IdleGoodsActivity extends BaseActivity {
    ...
    private void initView() {
        List<CommonType> mTList = (List<CommonType>) SPUtils.get(this, "IdleGoodsType", new TypeToken<List<CommonType>>() {
        }.getType());
        ...
        viewSales = new PopViewMoreEdit(this);
    ...
    private void initData() {
        ...
        mSheng = (Sheng) SPUtils.get(IdleGoodsActivity.this, "UserLocation", Sheng.class);
        if (mSheng != null) {
...
//            mTextArray.set(0,mSheng.getShi().getName());
            ...
            Sheng sheng = (Sheng) SPUtils.get(IdleGoodsActivity.this, "DiQu", Sheng.class);
            shengId = sheng.getId();
        ...
        mList = new ArrayList<>();
        mAdapter = new IdleGoodsListViewAdapter(this, R.layout.item_idle_goods_info, mList);
    ...
    private void initListener() {
        ...
        //* 选择价钱
        viewSales.setOnSelectListener(new PopViewMoreEdit.OnSelectListener() {
        ...
        mListview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                bundle.putSerializable("idleGoods", (Serializable) mList.get(position - 1));
    ...
    public void httpGetList() {
        Request<JSONObject> mRequest = NoHttp.createJsonObjectRequest(ConnectUrl.PUBLIC_IDLE_GOODS_LIST, RequestMethod.POST);
                    ...
                    try {
                        ...
                        if (jsonObject.getInt("code") == 200) {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                Gson gson = new Gson();
                                IdleGoods idleGoods = gson.fromJson(jsonObject1.toString(), IdleGoods.class);
                                mList.add(idleGoods);
                            }
                        }
