...
import com.linkhand.activity.my.MyReleaseActivity;
...
// TODO Auto-generated method stub
    ...
    @OnClick({R.id.info_layout, R.id.true_layout, R.id.fabu_layout, R.id.fankui_layout, R.id.collect_layout, R.id.pingjia_layout})
